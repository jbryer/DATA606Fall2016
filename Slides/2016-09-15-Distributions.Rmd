...
* If you are looking for an additional resource to learn R, I recommend Grolemund and Wickham's *R for Data Science* which is available at http://r4ds.had.co.nz/. A "dead tree" version will be ready by the end of the year.
* When starting a new lab, I suggest you change `eval=FALSE` to `eval=TRUE` for all R chunks.
* Working directories in R.
* New York Meetup Group: http://www.meetup.com/nyhackr/

## Meetup Presentations

* [Walt Wells](http://rpubs.com/c614python/207896) (3.1)
* [Andrew Carson](http://rpubs.com/brucehao/207842) (3.3)
